...
public class CreateUserCommand : IRequest<CreateUserResult>
{
    ...
    public CreateUserNameCommand Name { get; set; } = new();
    public CreateUserAddressCommand Address { get; set; } = new();
    ...
    public class CreateUserAddressCommand
    {
        ...
        public CreateUserGeolocationCommand Geolocation { get; set; } = new();
    }
